        ...
        <div className="bg-beige">
            ...
            <form method="GET" onSubmit={(e) => handleSubmit(e)} className="pt-32 mx-24 flex flex-row gap-9">
                <div className="flex flex-col gap-9 w-[70%] min-h-[50vh]">
                    <div className="p-5 bg-white-80 w-full min-h-[65vh] rounded-md">
                        <h5 className="text-dark-green text-3xl">Pesanan Anda</h5>
                        <div className="my-4 flex flex-row gap-4">
                            <div className="w-20 h-20 rounded-full bg-cover bg-center hover:opacity-80"
                                style={{ backgroundImage: `url(${NasiCampur})` }}>
                            </div>
                            <div className="flex flex-row bg-dark-green h-20 rounded-lg flex-1 text-white justify-between items-center px-4 text-lg">
                    ...
                    <div className="flex flex-row w-full justify-between items-center px-5 font-bold text-xl bg-white-80 py-3 rounded-md">
                        Jasa Pengiriman
                        <div className="relative">
                            <button type="button" onClick={() => setOpen(!open)} className={`bg-dark-green font-normal text-white flex items-center w-56 px-4 py-2 justify-between ${open ? 'rounded-t-md': 'rounded-md'}`}>
                                {value}
                    ...
                    <div className="flex flex-col bg-white-80 p-4 rounded-md">
                        ...
                        <label htmlFor="Keterangan" className="font-bold my-2">Keterangan</label>
                        <textarea 
                            placeholder="Tambahkan keterangan alamat" 
                            name="Keterangan" 
                            cols="30" rows="3" 
                            className="resize-none border-2 p-2"></textarea>
                    </div>
                </div>
                ...
                <div className="bg-white flex-1 p-4 text-lg mb-4 flex flex-col justify-center rounded-md">
                    <div className="min-h-[100vh]">
                        ...
                        <div className="w-full my-4">
                            <div className="bg-dark-green w-full py-2 pl-2 text-white rounded-t-md">Pilih Pembayaran</div>
